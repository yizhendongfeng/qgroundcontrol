...
ItemInfoSlot::ItemInfoSlot(const WaypointInfoSlot &infoSlot, QObject* parent)
    : QObject(parent)
    ,_majorType(0, "major type", FactMetaData::valueTypeUint8)
    , _minorType(0, "minor type", FactMetaData::valueTypeUint8)
    , _infoslotCount(0, "infoslot count", FactMetaData::valueTypeUint8)
    , _lon(0, "lon", FactMetaData::valueTypeDouble)
    , _lat(0, "lat", FactMetaData::valueTypeDouble)
    , _alt(0, "alt", FactMetaData::valueTypeFloat)
    , _radiusCh(0, "radius ch", FactMetaData::valueTypeFloat)
    , _rVGnd(0, "r v gnd", FactMetaData::valueTypeFloat)
    , _rRocDoc(0, "r roc doc", FactMetaData::valueTypeFloat)
    , _swTd(0, "sw td", FactMetaData::valueTypeFloat)
    , _swVGnd(0, "sw v gnd", FactMetaData::valueTypeFloat)
    , _rHdgDeg(0, "r hdg deg", FactMetaData::valueTypeFloat)
    , _actDeptMainEngine(0, "act dept main engine", FactMetaData::valueTypeUint8)

    , _actDeptDecelerate(0, "act dept decelerate", FactMetaData::valueTypeUint8)
    , _actDeptLandingGear(0, "act dept landing gear", FactMetaData::valueTypeUint8)
    , _actDeptPayload(0, "act dept payload", FactMetaData::valueTypeUint8)
    , _actDeptVehicle(0, "act dept vehicle", FactMetaData::valueTypeUint8)
    , _actDeptMnvr(0, "act dept maneuver", FactMetaData::valueTypeUint8)
    , _actArrvlMainEngine(0, "act arrvl main engine", FactMetaData::valueTypeUint8)

    , _actArrvlDecelerate(0, "act arrvl decelerate", FactMetaData::valueTypeUint8)
    , _actArrvlLandingGear(0, "act arrvl landing gear", FactMetaData::valueTypeUint8)
    , _actArrvlPayload(0, "act arrvl payload", FactMetaData::valueTypeUint8)
    , _actArrvlVehicle(0, "act arrvl vehicle", FactMetaData::valueTypeUint8)
    , _actArrvlMnvr(0, "act arrvl maneuver", FactMetaData::valueTypeUint8)
    , _swCondAuto(0, "sw cond auto switch", FactMetaData::valueTypeUint8)

    , _swCondSpeedSource(0, "sw cond speed source", FactMetaData::valueTypeUint8)
    , _swCondHorizontalError(0, "sw cond horizontal error", FactMetaData::valueTypeUint8)
    , _swCondHeight(0, "sw cond height", FactMetaData::valueTypeUint8)
    , _swCondSpeed(0, "sw cond speed", FactMetaData::valueTypeUint8)
    , _swCondLongitudinalMotion(0, "sw cond longitudinal motion", FactMetaData::valueTypeUint8)
    , _swCondReserved(0, "sw cond reserved", FactMetaData::valueTypeUint8)
    , _actInFlt(0, "act inflt", FactMetaData::valueTypeUint8)

    , _hgtCtrlMode(0, "hgt ctrl mode", FactMetaData::valueTypeUint8)
    , _hdgCtrlMode(0, "hdg ctrl mode", FactMetaData::valueTypeUint8)
    , _swAngDeg(0, "sw ang deg", FactMetaData::valueTypeInt8)
    , _swTurns(0, "sw turns", FactMetaData::valueTypeUint8)
    , _gdMode(0, "gd mode", FactMetaData::valueTypeUint8)
    , _mnvrStyEndMode(0, "mnvr sty end mode", FactMetaData::valueTypeUint8)

    , _mnvrStyTurn(0, "mnvr sty turn", FactMetaData::valueTypeUint8)
    , _mnvrStyReserved(0, "mnvr sty reserved", FactMetaData::valueTypeUint8)
    , _transSty(0, "trans sty", FactMetaData::valueTypeUint8)
    , _reserved0(0, "reserved0", FactMetaData::valueTypeUint8)
    , _reserved1(0, "reserved1", FactMetaData::valueTypeUint8)
    , _infoSlot(infoSlot)
