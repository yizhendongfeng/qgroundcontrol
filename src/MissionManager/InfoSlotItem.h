...
#ifndef InfoSlotItem_H
#define InfoSlotItem_H
...
class InfoSlotItem : public QObject
{
    Q_OBJECT
    
public:
    InfoSlotItem(QObject* parent = nullptr);

    InfoSlotItem(WaypointInfoSlot* infoSlot, QObject*        parent = nullptr);

    InfoSlotItem(const InfoSlotItem& other, QObject* parent = nullptr);

    ~InfoSlotItem();

    const InfoSlotItem& operator=(const InfoSlotItem& other);
