...
#include "InfoSlotItem.h"
#include "FirmwarePluginManager.h"
#include "QGCApplication.h"
#include "JsonHelper.h"
#include "VisualMissionItem.h"

const char*  InfoSlotItem::_jsonFrameKey =           "frame";
const char*  InfoSlotItem::_jsonCommandKey =         "command";
const char*  InfoSlotItem::_jsonAutoContinueKey =    "autoContinue";
const char*  InfoSlotItem::_jsonCoordinateKey =      "coordinate";
const char*  InfoSlotItem::_jsonParamsKey =          "params";
const char*  InfoSlotItem::_jsonDoJumpIdKey =        "doJumpId";

// Deprecated V1 format keys
const char*  InfoSlotItem::_jsonParam1Key =          "param1";
const char*  InfoSlotItem::_jsonParam2Key =          "param2";
const char*  InfoSlotItem::_jsonParam3Key =          "param3";
const char*  InfoSlotItem::_jsonParam4Key =          "param4";

InfoSlotItem::InfoSlotItem(QObject* parent)
    : QObject(parent)
    , _sequenceNumber(0)
    , _doJumpId(-1)
    ...
    , _param7Fact                   (0, "Altitude:",                    FactMetaData::valueTypeDouble)
{
    ...
    connect(&_param1Fact, &Fact::rawValueChanged, this, &InfoSlotItem::_param1Changed);
    connect(&_param2Fact, &Fact::rawValueChanged, this, &InfoSlotItem::_param2Changed);
    connect(&_param3Fact, &Fact::rawValueChanged, this, &InfoSlotItem::_param3Changed);
}

InfoSlotItem::InfoSlotItem(WaypointInfoSlot* infoSlot,
                         QObject*        parent)
    : QObject(parent)
    , _sequenceNumber(infoSlot)
    , _doJumpId(-1)
...
InfoSlotItem::InfoSlotItem(const InfoSlotItem& other, QObject* parent)
    : QObject(parent)
    , _sequenceNumber(0)
    , _doJumpId(-1)
    , _isCurrentItem(false)
...
const InfoSlotItem& InfoSlotItem::operator=(const InfoSlotItem& other)
{
...
InfoSlotItem::~InfoSlotItem()
{    

}

void InfoSlotItem::save(QJsonObject& json) const
{
...
bool InfoSlotItem::load(QTextStream &loadStream)
{
...
bool InfoSlotItem::_convertJsonV1ToV2(const QJsonObject& json, QJsonObject& v2Json, QString& errorString)
{
    // V1 format type = "InfoSlotItem", V2 format type = "InfoSlotItem"
    ...
    if (v2Json[VisualMissionItem::jsonTypeKey].toString() == QStringLiteral("InfoSlotItem")) {
...
bool InfoSlotItem::_convertJsonV2ToV3(QJsonObject& json, QString& errorString)
{
...
bool InfoSlotItem::load(const QJsonObject& json, int sequenceNumber, QString& errorString)
{
...
void InfoSlotItem::setSequenceNumber(int sequenceNumber)
{
...
void InfoSlotItem::setCommand(MAV_CMD command)
{
...
void InfoSlotItem::setFrame(MAV_FRAME frame)
{
    if (this->frame() != frame) {
...
void InfoSlotItem::setAutoContinue(bool autoContinue)
{
...
void InfoSlotItem::setIsCurrentItem(bool isCurrentItem)
{
...
void InfoSlotItem::setParam1(double param)
{
    if (param1() != param) {
...
void InfoSlotItem::setParam2(double param)
{
    if (param2() != param) {
...
void InfoSlotItem::setParam3(double param)
{
    if (param3() != param) {
...
void InfoSlotItem::setParam4(double param)
{
    if (param4() != param) {
...
void InfoSlotItem::setParam5(double param)
{
    if (param5() != param) {
...
void InfoSlotItem::setParam6(double param)
{
    if (param6() != param) {
...
void InfoSlotItem::setParam7(double param)
{
    if (param7() != param) {
...
QGeoCoordinate InfoSlotItem::coordinate(void) const
{
...
double InfoSlotItem::specifiedFlightSpeed(void) const
{
...
double InfoSlotItem::specifiedGimbalYaw(void) const
{
...
double InfoSlotItem::specifiedGimbalPitch(void) const
{
...
void InfoSlotItem::_param1Changed(QVariant value)
{
    Q_UNUSED(value);
...
void InfoSlotItem::_param2Changed(QVariant value)
{
    Q_UNUSED(value);
...
void InfoSlotItem::_param3Changed(QVariant value)
{
    Q_UNUSED(value);
