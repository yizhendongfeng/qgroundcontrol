...
class SettingsManager : public QObject
{
    ...
    Q_MOC_INCLUDE("CloudServerSettings.h")
#ifdef QGC_VIEWER3D
    ...
    Q_PROPERTY(QObject *cloudServerSettings             READ cloudServerSettings            CONSTANT)
#ifdef QGC_VIEWER3D
...
public:
    ...
    CloudServerSettings *cloudServerSettings() const;
#ifdef QGC_VIEWER3D
...
private:
    ...
    CloudServerSettings *_cloudServerSettings = nullptr;
#ifdef QGC_VIEWER3D
