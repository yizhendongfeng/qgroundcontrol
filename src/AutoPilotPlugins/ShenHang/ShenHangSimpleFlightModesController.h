...
#ifndef ShenHangSimpleFlightModesController_H
#define ShenHangSimpleFlightModesController_H
...
/// MVC Controller for ShenHangSimpleFlightModes.qml
class ShenHangSimpleFlightModesController : public FactPanelController
{
    Q_OBJECT
    
public:
    ShenHangSimpleFlightModesController(void);
