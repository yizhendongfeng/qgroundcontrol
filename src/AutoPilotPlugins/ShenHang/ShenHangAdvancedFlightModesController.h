...
#ifndef ShenHangAdvancedFlightModesController_H
#define ShenHangAdvancedFlightModesController_H
...
class ShenHangAdvancedFlightModesController : public FactPanelController
{
    Q_OBJECT
    
public:
    ShenHangAdvancedFlightModesController(void);
