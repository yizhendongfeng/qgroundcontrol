...
ShenHangSimpleFlightModesController::ShenHangSimpleFlightModesController(void)
    : _activeFlightMode(0)
...

{
    ...
    connect(_vehicle, &Vehicle::rcChannelsChanged, this, &ShenHangSimpleFlightModesController::_rcChannelsChanged);
}

/// Connected to Vehicle::rcChannelsChanged signal
void ShenHangSimpleFlightModesController::_rcChannelsChanged(int channelCount, int pwmValues[Vehicle::cMaxRcChannels])
{
