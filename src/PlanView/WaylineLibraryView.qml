...
Item {
    ...
    /// 下载完成。autoLoad 为 true 时（单条下载）PlanView 把它转成 .plan 载进
    /// 编辑器；批量下载时为 false —— 一次下 5 条连着载 5 次编辑器毫无意义
    ...
    ColumnLayout {
        ...
        Rectangle {
            ...
            ColumnLayout {
                ...
                QGCListView {
                    ...
                    Layout.fillWidth:  true
                    Layout.fillHeight: true
                    model:             root.wayline ? root.wayline.listModel : null
                    clip:              true
                    spacing:           0
                    currentIndex:      -1
                    ...
                    QGCLabel {
                        ...
                        text:                qsTr("没有航线。切到「本地任务」勾选后点「上传到云端」即可上传第一条。")
                    }
                }
                ...
                Rectangle {
                    ...
                    RowLayout {
                        ...
                        QGCButton {
                            text:      qsTr("‹")
                            enabled:   root.wayline && root.wayline.currentPage > 1 && !root.wayline.busy
                        ...
                        QGCButton {
                            text:      qsTr("›")
                            enabled:   root.wayline && root.wayline.currentPage < root.wayline.totalPages && !root.wayline.busy
                            onClicked: root.refresh(root.wayline.currentPage + 1)
                        }
                        ...
                        QGCButton {
                            text:      qsTr("刷新")
                            enabled:   root.wayline && !root.wayline.busy
        ...
        ColumnLayout {
            ...
            RowLayout {
                ...
                QGCLabel {
                    text:           root._listOk ? qsTr("● 航线接口正常") : qsTr("○ 航线接口未就绪")
                    color:          root._listOk ? qgcPal.colorGreen : qgcPal.colorGrey
                    font.pointSize: ScreenTools.defaultFontPointSize
                }
                QGCLabel {
